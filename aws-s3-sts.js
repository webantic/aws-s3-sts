AWS = {};
// Add AJAX to the server
if ( Meteor.isServer ) {
	XMLHttpRequest = Npm.require('xhr2').XMLHttpRequest;
	DOMParser = Npm.require('xmldom').DOMParser;
}
...
_xamzrequire({
    ...
    21: [ function(require, module, exports) {
        var innerAWS = require("./core");
        innerAWS.apiLoader = function(svc, version) {
            return AWS.apiLoader.services[svc][version];
        };
        innerAWS.apiLoader.services = {};
        innerAWS.XML.Parser = require("./xml/browser_parser");
        require("./http/xhr");
        AWS = innerAWS;
    }, {
        "./core": 24,
    ...
    85: [ function(require, module, exports) {
        ...
        DomXmlParser.prototype.parse = function(xml, shape) {
            ...
            var result, error;
            try {
                if (typeof window !== 'undefined' && window.DOMParser || DOMParser) {
                    try {
    ...
    72: [ function(require, module, exports) {
        ...
        innerAWS.util.update(innerAWS.S3.prototype, {
            ...
            setupRequestListeners: function setupRequestListeners(request) {
                ...
                request.removeListener("validate", innerAWS.EventListeners.Core.VALIDATE_REGION);
                request.addListener("extractError", this.extractError);
                request.addListener("extractData", this.extractData);
                request.addListener("extractData", innerAWS.util.hoistPayloadMember);
            ...
            addExpect100Continue: function addExpect100Continue(req) {
                ...
                if (innerAWS.util.isNode() && len >= 1024 * 1024) {
            ...
            willComputeChecksums: function willComputeChecksums(req) {
                ...
                if (!innerAWS.util.Buffer.isBuffer(req.httpRequest.body) && typeof req.httpRequest.body !== "string") {
                    return false;
                }
            ...
            computeContentMd5: function computeContentMd5(req) {
                if (req.service.willComputeChecksums(req)) {
                    var md5 = innerAWS.util.crypto.md5(req.httpRequest.body, "base64");
            ...
            computeSseCustomerKeyMd5: function computeSseCustomerKeyMd5(req) {
                ...
                innerAWS.util.each(keys, function(key, header) {
                    if (req.params[key]) {
                        var value = innerAWS.util.crypto.md5(req.params[key], "base64");
            ...
            retryableError: function retryableError(error, request) {
                if (request.operation === "completeMultipartUpload" && error.statusCode === 200) {
                    ...
                    var _super = innerAWS.Service.prototype.retryableError;
            ...
            extractError: function extractError(resp) {
                ...
                if (codes[code] && body.length === 0) {
                    resp.error = innerAWS.util.error(new Error(), {
                        code: codes[resp.httpResponse.statusCode],
                        message: null
                    });
                } else {
                    var data = new innerAWS.XML.Parser().parse(body.toString());
                    resp.error = innerAWS.util.error(new Error(), {
                        code: data.Code || code,
            ...
            getSignedUrl: function getSignedUrl(operation, params, callback) {
                params = innerAWS.util.copy(params || {});
            ...
            upload: function upload(params, options, callback) {
                ...
                options = options || {};
                options = innerAWS.util.merge(options || {}, {
                    service: this,
                    params: params
                });
                var uploader = new innerAWS.S3.ManagedUpload(options);
    ...
    74: [ function(require, module, exports) {
        ...
        var innerAWS = require("../core");
        innerAWS.util.update(innerAWS.STS.prototype, {
            credentialsFrom: function credentialsFrom(data, credentials) {
                if (!data) return null;
                if (!credentials) credentials = new innerAWS.TemporaryCredentials();
                credentials.expired = false;
                credentials.accessKeyId = data.Credentials.AccessKeyId;
